...
export const mockWorkspaces: WorkspaceType[] = [
  { id: "ws1", name: "Nature Escapes", icon: <TreePine size={24} /> },
  { id: "ws2", name: "Home & Garden", icon: <Sprout size={24} /> },
  { id: "ws3", name: "Alpine Club", icon: <MountainSnow size={24} /> },
];
...
export const mockMessages: Record<string, MessageType[]> = {
  ...
  group3: [
    { id: "m9", sender: mockUsers["user4"], content: "Need volunteers this Sat for trail clearing near the waterfall.", timestamp: new Date(Date.now() - 3600 * 1000 * 24 * 2), upvotes: 2, downvotes: 0 },
    { id: "m10", sender: mockUsers["user1"], content: "I can make it!", timestamp: new Date(Date.now() - 3600 * 1000 * 24 * 2 - 60000 * 5), upvotes: 1, downvotes: 0 },
  ],
};
